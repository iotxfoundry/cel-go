...
var randFunctions = []cel.EnvOption{
	...
	cel.Function(overloads.MathRandDouble,
		// math.randf() -> double
		cel.Overload(overloads.MathRandDoubleNone,
			[]*cel.Type{},
			cel.DoubleType,
		...
		cel.Overload(overloads.MathRandDoubleInt,
		...
		cel.Overload(overloads.MathRandDoubleUint,
		...
		cel.Overload(overloads.MathRandDoubleDouble,
	...
	cel.Function(overloads.MathRandInt,
		// math.randi() -> int
		cel.Overload(overloads.MathRandIntNone,
			[]*cel.Type{},
			cel.IntType,
			cel.FunctionBinding(func(values ...ref.Val) ref.Val {
				if len(values) != 0 {
		...
		// math.randi(int) -> int
		cel.Overload(overloads.MathRandIntInt,
			[]*cel.Type{cel.IntType},
			cel.IntType,
			cel.UnaryBinding(func(value ref.Val) ref.Val {
				base, ok := value.(types.Int)
		...
		cel.Overload(overloads.MathRandIntIntInt,
		...
		cel.Overload(overloads.MathRandIntIntUint,
		...
		cel.Overload(overloads.MathRandIntIntDouble,
		...
		// math.randi(uint) -> int
		cel.Overload(overloads.MathRandIntUint,
			[]*cel.Type{cel.UintType},
			cel.IntType,
			cel.UnaryBinding(func(value ref.Val) ref.Val {
				base, ok := value.(types.Uint)
		...
		cel.Overload(overloads.MathRandIntUintInt,
		...
		cel.Overload(overloads.MathRandIntUintUint,
		...
		cel.Overload(overloads.MathRandIntUintDouble,
		...
		cel.Overload(overloads.MathRandIntDouble,
			[]*cel.Type{cel.DoubleType},
			cel.IntType,
			cel.UnaryBinding(func(value ref.Val) ref.Val {
				base, ok := value.(types.Double)
		...
		cel.Overload(overloads.MathRandIntDoubleInt,
		...
		cel.Overload(overloads.MathRandIntDoubleUint,
		...
		cel.Overload(overloads.MathRandIntDoubleDouble,
	...
	cel.Function(overloads.MathRandUint,
		// math.randui() -> uint
		cel.Overload(overloads.MathRandUintNone,
			[]*cel.Type{},
			cel.UintType,
			cel.FunctionBinding(func(values ...ref.Val) ref.Val {
				if len(values) != 0 {
		...
		cel.Overload(overloads.MathRandUintInt,
			[]*cel.Type{cel.IntType},
			cel.UintType,
			cel.UnaryBinding(func(value ref.Val) ref.Val {
				base, ok := value.(types.Int)
		...
		cel.Overload(overloads.MathRandUintUint,
			[]*cel.Type{cel.UintType},
			cel.UintType,
			cel.UnaryBinding(func(value ref.Val) ref.Val {
				base, ok := value.(types.Uint)
		...
		cel.Overload(overloads.MathRandUintDouble,
			[]*cel.Type{cel.DoubleType},
			cel.UintType,
			cel.UnaryBinding(func(value ref.Val) ref.Val {
				base, ok := value.(types.Double)
